    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button id="exportButton" class="btn btn-primary" onclick="window.location.href='/committees/export/{{$stat}}'">@lang('messages.export')</button>
            </div>
            {{-- <div class="row">
                        ...
                        <thead class="thead-light">
                            <tr>
                                {{-- <th scope="col" style="{{ auth()->check() && auth()->user()->hasRole('faculty-member') ? '' : 'display: none;' }}">@lang('messages.student')</th> --}}
                                    ...
                                    <th scope="col">@lang('messages.committee_decision')</th> 
                                    <th scope="col">@lang('messages.current_absence_percentage')</th>
                                    <th scope="col">@lang('messages.status_deprivation')</th> 
                                    @endif
    ...
    function updateStatus(Id, status) {
        ...
        if (status) {
            ...
            htmlContent = `
                        <div class="form-group">
                            <input type="decimal" class="form-control" id="current_absence_percentage" name="current_absence_percentage"  placeholder="{{ __('messages.current_absence_percentage') }}">
                        </div>
            `;
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios.post('/committees/update-excuse', formData, {
                    headers: {
